...
import softuniBlog.repository.RoleRepositiry;
...
public class AdminUserController {
    ...
    public String edit(@PathVariable Integer id, Model model) {
        ...
        List<Role> roles = this.roleRepositiry.findAll();
    ...
    public String editProcess(@PathVariable Integer id, UserEditBindingModel userBindingModel) {
        ...
        if (!StringUtils.isEmpty(userBindingModel.getPassword())
            ...
            if (userBindingModel.getPassword().equals(userBindingModel.getConfirmPassword())) {
                BCriptPasswordEncoder bCriptPasswordEncoder = new BCriptPasswordEncoder();

                user.setPassword(bCriptPasswordEncoder.encode(userBindingModel.getPassword()));
            }
        }
        ...
        for (Integer roleId : userBindingModel.getRoles()) {
            roles.add(this.roleRepositiry.findOne(roleId));
        }
